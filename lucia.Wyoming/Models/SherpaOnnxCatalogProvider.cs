...
public sealed class SherpaOnnxCatalogProvider(
    ...
    IOptionsMonitor<SpeechEnhancementOptions> enhancementOptions) : IModelCatalogProvider
{
    public ModelSource Source => ModelSource.SherpaOnnx;
    ...
    [
        new()
        {
            ...
            Description = "NVIDIA English TitaNet-small speaker embedding model for verification and enrollment.",
            Languages = ["en"],
        ...
        new()
        {
            ...
            EngineType = EngineType.SpeakerEmbedding,
            Description = "Mandarin-domain 3D-Speaker ERes2Net model for voice enrollment and verification.",
            Languages = ["zh"],
    ...
    [
        new()
        {
            ...
            DownloadUrl = "https://huggingface.co/onnx-community/granite-4.0-1b-speech-ONNX",
            Source = ModelSource.HuggingFace,
            RepoId = "onnx-community/granite-4.0-1b-speech-ONNX",
            IsDefault = false,
            MinMemoryMb = 2048,
            IsArchive = false,
        },
        ...
        new()
        {
            ...
            EngineType = EngineType.OfflineStt,
            Description = "NVIDIA Parakeet TDT 0.6B v3 multilingual offline transcription with automatic language detection.",
    ...
    public Task<IReadOnlyList<WyomingModelDefinition>> GetModelsAsync(
        EngineType engineType,
        CancellationToken ct = default) =>
        Task.FromResult(GetCatalogForEngine(engineType));

    public Task<WyomingModelDefinition?> GetModelByIdAsync(
        EngineType engineType,
        string modelId,
        CancellationToken ct = default) =>
        Task.FromResult(
    ...
    private static IReadOnlyList<WyomingModelDefinition> GetCatalogForEngine(EngineType engineType) =>
        engineType switch
        {
